...
// idk::Propeller::Propeller( idk::phys::World &world, float span, float chord )
// :   m_world         (world),
//     m_span          (4.0f*span),
//     m_chord         (4.0f*chord),
...
// idk::Propeller::_sampleLiftDragCoefficients( float aoa )
// {
//     // idk_printvalue(aoa);
...
// glm::vec3
// idk::Propeller::computeAeroForces( const glm::mat4 &parent )
// {
...
// glm::mat4
// idk::Propeller::getRenderMatrix( const glm::mat4 &parent )
// {
//     glm::mat4 T = glm::translate(glm::mat4(1.0f), localpos);
//     glm::mat4 R = glm::mat4_cast(glm::angleAxis(wingAngle, glm::vec3(1, 0, 0)));
