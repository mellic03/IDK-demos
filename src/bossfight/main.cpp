...
void
DemoBossfight::registerModules( idk::EngineAPI &api )
{
    using namespace idk;
...
void
DemoBossfight::setup( const std::vector<std::string> &args, idk::EngineAPI &api )
{
    using namespace idk;
...
void
DemoBossfight::mainloop( idk::EngineAPI &api )
{
    using namespace idk;
...
void
DemoBossfight::shutdown()
{
    LOG_INFO() << "DemoBossfight::shutdown";
